...
fn test_simple_factory_call() -> Result<()> {
    ...
    println!("🎯 SIMPLE FACTORY CALL TEST");
    println!("===========================");
    ...
    println!("✅ Factory template deployed at block 4, tx 0x701");

    // PHASE 2: Initialize factory using 6→4→2 pattern
    println!("\n🏭 PHASE 2: Initializing Factory");
                        ...
                        vec![
                            Protostone {
                                message: into_cellpack(vec![
                                    6u128, 0x701, 0u128,  // Initialize factory using 6→4→2 pattern
    ...
    let factory_id = AlkaneId { block: 4, tx: 1793 }; // Factory instance created by 6→4→2 pattern
    println!("✅ Factory initialized at {:?}", factory_id);

    // PHASE 3: Use working free-mint setup from other tests
    println!("\n🪙 PHASE 3: Using existing free-mint contract (block 2, tx 1)");
    ...
    println!("✅ Tokens minted from free-mint contract");

    // PHASE 4: Call factory with tokens (simplified)
    println!("\n🎫 PHASE 4: Direct Factory Call with Tokens");
    ...
    println!("🔍 Available tokens at mint outpoint: {} (token id: {:?})", available_tokens, token_id);
    ...
    println!("✅ Factory call made with tokens");
    println!("🔍 This should trigger CREATE_COUPON debug output if working");
